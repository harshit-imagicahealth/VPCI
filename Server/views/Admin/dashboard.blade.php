...
@section('content')
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="stat-card">
                <div class="stat-icon" style="background:var(--primaryThemeColor)"><i class="fa fa-video"></i></div>
                <div>
                    <h3>{{ $categoryCount }}</h3>
                    <p>Categorys</p>
                </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="stat-card">
                <div class="stat-icon" style="background:var(--primaryThemeColor)"><i class="fa fa-book-open"></i></div>
                <div>
                    <h3>120</h3>
                    <p>Resources</p>
                </div>
