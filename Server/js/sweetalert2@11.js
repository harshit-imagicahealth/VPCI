...
(!(function (e, t) {
    ...
    const he = [
        ...
        ge = (e) => {
            ...
            if (!Ae[e.input])
                return void d(
                    `Unexpected type of input! Expected ${Object.keys(Ae).join(" | ")}, got "${e.input}"`,
                );
            const t = we(e.input);
            if (!t) return;
    ...
    const He = (e) => {
        ...
        _e = (e) => {
            ...
            return (
                ...
                e.progressStepsDistance &&
                    Y(t, "width", e.progressStepsDistance),
                t
            );
        },
        Fe = (e, t) => {
        ...
        Qe = (e, t, n) => {
            (e.preventDefault(), h(t.allowEscapeKey) && n(Ue.esc));
        };
    var et = {
    ...
    function ut(e, t, n, s) {
        (V() ? yt(e, s) : (i(n).then(() => yt(e, s)), ze(o)),
            ...
            D() &&
                (null !== lt &&
                    ((document.body.style.paddingRight = `${lt}px`),
                    (lt = null)),
                (() => {
        ...
        Xn = (e, t) => {
            if (!t.toast)
                return h(t.allowEnterKey)
                    ...
                    : (m("allowEnterKey", "preConfirm: () => false"),
                      void e.popup.focus());
        },
        Zn = (e) => {
