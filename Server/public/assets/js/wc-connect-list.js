(function (dataFetchUrl, exportUrl, deleteUrl, editUrl, questionsUrl, csrf) {
  let dtPage = 1;
  let dtPerPage = 8;
  let dtSortCol = null;
  let dtSortDir = 1;
            ...
            <tr>
                ...
                <td>
                    <div class="dt-action-wrap">
                      <!-- Questions -->
                      <a href="${questionsUrl.replace(":id", r.encrypt_id)}"
                        class="dt-action dt-action-questions"
                        title="Questions">
                      ...
                      class="dt-action dt-action-edit" title="Edit">
                      <i class="fa fa-pen"></i>
                      </a>

                      <!-- Delete -->
                      <button type="button" data-id="${r.encrypt_id}" class="dt-action dt-action-delete delete-btn" title="Delete">
  ...
  /* ── Init ── */
  dtFetch();
})(dataFetchUrl, exportUrl, deleteUrl, editUrl, questionsUrl, csrf);
