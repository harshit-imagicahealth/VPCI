...
!(function (a) {
    ...
    k.prototype = {
        ...
        setUTCDates: function () {
            ...
            return (
                this.setDates.apply(this, a.map(b, this._utc_to_local)),
                this
            );
        },
        setDate: f("setDates"),
                    ...
                    if (-1 !== g) {
                        if (
                            ...
                            for (
                                ...
                                h >= 0 &&
                                e < this.dates[h] &&
                                (this.pickers[h].element.val() || "").length >
                                    0;
                            )
                            ...
                            for (
                                ...
                                i < j &&
                                e > this.dates[i] &&
                                (this.pickers[i].element.val() || "").length >
                                    0;
                            )
